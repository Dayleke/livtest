...
/* Smarty version 3.1.33, created on 2024-12-13 00:27:59
  from '/var/www/html/LEAF_Request_Portal/templates/reports/LEAF_Inbox.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_675b7f8f895ad3_26049833',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '225c3c51b77cda0dec0d0e737fa8743cf9671325' => 
    array (
      0 => '/var/www/html/LEAF_Request_Portal/templates/reports/LEAF_Inbox.tpl',
      1 => 1734040697,
      2 => 'file',
    ),
  ),
  'includes' => 
  array (
    'file:site_elements/generic_OkDialog.tpl' => 1,
    'file:site_elements/generic_confirm_xhrDialog.tpl' => 1,
  ),
),false)) {
function content_675b7f8f895ad3_26049833 (Smarty_Internal_Template $_smarty_tpl) {
echo '<script'; ?>
 src="../libs/js/sha1.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 src="../libs/js/LEAF/intervalQueue.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
>
    let CSRFToken = '<?php echo $_smarty_tpl->tpl_vars['CSRFToken']->value;?>
';
            ...
            'status': function(site) {
                return {
                    ...
                    callback: function(data, blob) {
                        ...
                        if (listRecord.userID == '<?php echo $_smarty_tpl->tpl_vars['userID']->value;?>
') {
...
<?php $_smarty_tpl->_subTemplateRender("file:site_elements/generic_OkDialog.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, false);
...
<div style="display:flex;gap:0.25rem;justify-content:flex-end;">
    ...
    <button type="button" id="btn_adminView" class="buttonNorm" style="<?php if (!$_smarty_tpl->tpl_vars['empMembership']->value['groupID'][1]) {?>display: none<?php }?>">View as Admin</button>
</div>
<br />
